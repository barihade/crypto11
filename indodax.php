<?php
    ...
    include('koneksi.php');
    $idr = $conn->query("SELECT * FROM `sinyal` WHERE pair LIKE '%IDR' AND exchange = 'Indodax'");
    $btc = $conn->query("SELECT * FROM `sinyal` WHERE pair LIKE '%BTC' AND exchange = 'Indodax'");
...
<body class="animsition" style="background-color: dodgerblue;">
    ...
    <nav>
        <div class="nav nav-tabs mb-0" id="nav-tab" role="tablist" style="background-color: white;">
            <a class="nav-item nav-link active" id="nav-idr-tab" data-toggle="tab" href="#nav-idr" role="tab" aria-controls="nav-home"
                aria-selected="true" style="margin: auto;">IDR</a>
        ...
        <div class="section__content section__content--p30">
            ...
            <div class="default-tab">
                <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-idr" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <div class="list-group pr-3">
                            ...
                            while($row = $idr->fetch()){ 
                                ...
                                <a class="list-group-item list-group-item-action" href="detailindodax.php?id=<?= $row[0]; ?>">
