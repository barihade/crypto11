<?php
    ...
    function ticker(){
        GLOBAL $sinyal;
        $symbol = str_replace("/", "_", $sinyal[2]);
        $symbol = strtolower($symbol);
        $url = "https://indodax.com/api/".$symbol."/ticker";
        $data = getData($url);
...
<body class="animsition" style="background-color: dodgerblue;">
    <nav class="navbar navbar-sm py-0" style="background-color: rgb(25, 124, 223)">
        <a class="navbar-brand" href="indodax.php">
                ...
                <div class="au-card mx-3 my-2" style="background-color: rgb(239, 239, 240);">
                    <div class="au-card-inner">
                        ...
                        <?php
                            ...
                            echo '<img src="'.$imgUrl.'">'; ?>
                        <p class="my-2">Last Price <?= $ticker->last; ?></p>
                        <p class="my-2">Low Price <?= $ticker->low; ?></p>
                        <p>High Price <?= $ticker->high; ?></p>
                    </div>
                </div>
                <div class="au-card mx-3" style="background-color: rgb(239, 239, 240);">
                    <div class="au-card-inner">
                        <h5><?= ($currency[1]=='BTC') ? $currency[1] : 'IDR'  ?></h5><br>
                        <div class="row">
